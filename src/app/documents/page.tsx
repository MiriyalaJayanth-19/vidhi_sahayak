...
export default function DocumentsIndexPage() {
  return (
    <div className="section-shell">
      ...
      {/* Quick Create Bar */}
      <div className="mb-10 rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-500 p-6 premium-shadow-lg relative overflow-hidden">
        <div className="absolute -top-12 -right-12 w-40 h-40 bg-white/10 rounded-full blur-2xl pointer-events-none" />
        <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-lg font-semibold text-white">Quick Create</h2>
            <p className="text-sm text-violet-100/80 mt-1">Start generating a legal document right now — fill in the form and print.</p>
          </div>
          <Link
            href="/documents/new"
            className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-2.5 text-sm font-semibold text-violet-600 shadow-lg shadow-violet-900/20 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 shrink-0"
          >
